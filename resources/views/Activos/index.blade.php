 ...
 <div class="container-fluid shadow-sm p-3 mb-5 bg-white rounded">
     ...
     <div class="row">
         <div class="col-md-12">
             <div class="">
                 <a href="{{route('activos.create')}}" class="btn btn-sm btn-primary col-lg-2">
                     Crear

                 </a>
             </div>
             <!-- <div class="pt-1">
                 <a href="{{route('reporte_activos')}}" class="btn btn-sm btn-primary col-lg-2">

                     reporte
                 </a>
             </div>
             <div class="pt-1">
                 <a href="{{route('reporte_activos_filter')}}" class="btn btn-sm btn-primary col-lg-2">
